(function () {
    ...
    // Cloud custom: Allow iframe embed from YouTube and SoundCloud
    ...
    function sanitizeTag(tag) {
        if (tag.match(basic_tag_whitelist) || tag.match(a_white) || tag.match(img_white) || tag.match(iframe_youtube) || tag.match(iframe_soundcloud)) {
            return tag;
        } else {
            return "";
        }
