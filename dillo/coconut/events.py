...
def source_transferred(job: dict, video: PostMediaVideo):
...
def output_processed_images(job: dict, video: PostMediaVideo):
    ...
    video.thumbnail = source_path
    video.save()


def output_processed_video(job: dict, video: PostMediaVideo):
...
def job_completed(job: dict, video: PostMediaVideo, post: Post):
